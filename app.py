"""
Updates:
1. Show PDF in left column.
2. Add user-controlled summarization (button for each paragraph, no auto-run).
3. Skip short paragraphs (<30 words).
4. Clean Qwen reasoning output (remove "thinking" content).
"""
...
if uploaded is not None:
    ...
    with left:
        ...
        st.download_button("Download PDF", pdf_bytes, file_name="document.pdf")
        st.components.v1.html(f'<iframe src="data:application/pdf;base64,{pdf_bytes.hex()}" width="100%" height="600"></iframe>', height=600)
