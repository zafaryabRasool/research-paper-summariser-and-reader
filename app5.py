...
if uploaded is not None:
    ...
    # # Before looping over paragraphs
    # if 'summaries' not in st.session_state:
    #     st.session_state['summaries'] = {}  # key: idx, value: text
